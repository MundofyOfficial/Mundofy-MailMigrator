{
    $Id: getopts.pp,v 1.3 2001/01/11 18:38:24 peter Exp $
    ...
    Modified 2001/08/05 AD to compile unter delphi also
...
{$ifdef win32}
VAR ParamStr0 : STRING;
function GetCommandFile:pchar;
begin
  ParamStr0 := ParamStr (0);
  Result := PChar (ParamStr0);
end;
{$else}
